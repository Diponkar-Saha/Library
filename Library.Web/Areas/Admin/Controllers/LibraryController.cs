...
using Infrastructure.Features.Exceptions;
...
namespace Library.Web.Areas.Admin.Controllers
{
    ...
    public class LibraryController : Controller
    {
        ...
        ILogger<LibraryController> _logger;


        public LibraryController(ILifetimeScope scope, ILogger<LibraryController> logger)
        {
            _scope = scope;
            _logger = logger;
        }
        ...
        public async Task<JsonResult> GetLibrarys()
        {
